...
class Debtors(models.Model):
    ...
    DebtorsID = models.AutoField(auto_created = True,
                                    primary_key = True,
                                    serialize = False, 
                                    verbose_name ='ID')
...
class Employees(models.Model):
    ...
    rating = models.DecimalField('Avaliação', max_digits=15, blank=False, decimal_places=2, default='0')
    departament_type = models.CharField(max_length=20,  blank=False, default='Varejo',
                                        choices=(('Varejo', 'Varejo'),
                                            ('Manutenção', 'Manutenção'),
                                            ))
    PhotoFileNAme = models.CharField(max_length=100, default='SOME STRING')
